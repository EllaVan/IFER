...
def mot_parse_args():
    ...
    parser.add_argument('--manualSeed', type=int, default=8320, help='manual seed')
    parser.add_argument('--lr', type=float, default=0.0001)
    parser.add_argument('--dataset', type=str, default="RAF")
    parser.add_argument('--means_file', type=str,
                        default='save/RAF/2022-03-18/encoder/net_state/epoch200')
    parser.add_argument('--log_dir', type=str, default="save/RAF/2022-03-18/decoder_2")

    parser.add_argument('--start_epoch', type=int, default=0, help='save interval')
    parser.add_argument('--start_file', type=str,
                        default='save/RAF/decoder0318/mot_gen_epoch20')
