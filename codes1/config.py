...
def get_config():
    ...
    parser.add_argument('--dataset', type=str, default='RAF-DB', choices=['RAF-DB', 'AffectNet', 'FERPLUS'])

    # Training settings
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--num_AU', type=int, default=16)
    ...
    # Encoder settings
    parser.add_argument('--enc_arch', type=str, default='resnet18', choices=['resnet', 'resnet18', 'dcgan'],
    ...
    parser.add_argument('--g_conv_dim', type=int, default=64, help='base number of channels in encoder and generator')
    # Discriminator settings
    parser.add_argument('--dis_fc_size', type=int, default=2048, help='number of nodes in fc layer of joint discriminator')
    parser.add_argument('--d_conv_dim', type=int, default=64, help='base number of channels in discriminator')
    ...
    parser.add_argument('--save_n_samples', type=int, default=64) # 大概是batch_size?
